function patch() {
    if (
        !Object.hasOwn(ShadowRoot.prototype,"getSelection")
    ) {
...
class TextField extends HTMLElement {
    ...
    get #_fieldInner():HTMLDivElement { return this.#_shadow.querySelector("#textfield")!; }
    get #_placeholder():HTMLDivElement { return this.#_shadow.querySelector("#placeholder")!; }
    ...
    get invalid():"grammar"|"spelling"|"true"|"false" { return this.getAttribute("invalid") as "grammar"|"spelling"|"true"|"false"; }
    set invalid(v:"grammar"|"spelling"|"true"|"false") {  this.setAttribute("invalid",v); this.#_fieldInner.ariaInvalid = v; }
    ...
    attributeChangedCallback(name:string,o?:string,n?:string){
        if(name == "disabled") { this.disabled = this.disabled; }
        if(name == "required") { this.required = this.required; }
        if(name == "readonly") { this.readOnly = this.readOnly; }
